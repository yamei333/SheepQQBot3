...
namespace SheepQQBot3.Model.Extension
{
    public static partial class RegexGenerator
    {
        ...
        [GeneratedRegex(@"\d{4}-\d{2}-\d{2}-\d-\d 23:(55|56|57|58):\d{2}")]
        public static partial Regex GenshinResin();

        [GeneratedRegex(@"\d{4}-\d{2}-\d{2}-\d-\d 23:(50|51|52|53):\d{2}")]
        public static partial Regex GenshinDailyMission();

        [GeneratedRegex(@"\d{4}-\d{2}-\d{2}-\d-\d (09|13|18|23|01):(00|01|02|03):\d{2}")]
        public static partial Regex GenshinPotCoin();

        [GeneratedRegex(@"\d{4}-\d{2}-\d{2}-\d-\d (19|23):(00|01|02|03):\d{2}")]
        public static partial Regex GenshinTransformer();

        [GeneratedRegex(@"\d{4}-\d{2}-\d{2}-\d-\d (18|21):(05|06|07|08):\d{2}")]

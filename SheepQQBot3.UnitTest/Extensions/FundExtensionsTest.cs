...
public class FundExtensionsTest
{
    ...
    [TestMethod]
    public async Task GetFundPositionTest()
    {
        //var jsonText =
        ...
        //var fundPositionData = JsonExtensions.DeserializeObject<FundPostionData>(jsonText);
        var fundPositionData = await FundExtensions.GetFundPositionDataAsync("004235").ConfigureAwait(false);

        ...
        GroupMessage groupMessage)
    {
        ...
        if (string.IsNullOrEmpty(upperMessage))
        {
            ...
            try
            {
                ...
                {
                    var spiralAbyssInfo = await client.GetSpiralAbyssInfoAsync(role, 1, CancellationToken.None).ConfigureAwait(false);
                ...
                var dailyNote = await client.GetDailyNoteAsync(role).ConfigureAwait(false);
